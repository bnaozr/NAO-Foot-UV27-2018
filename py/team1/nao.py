    ...
    def sidestepL(self):
        ...
        for i in range( len(footStepsList) ):
            self.motion.setFootStepsWithSpeed(
                ...
                clearExisting)
    def insulte(self):
        L=["Ma grand-mère joue mieux que toi","Ba alors, casse toi pauvre con", "Allez Paris", "Vous n'avez pas honte?", "Ba alors, on attend pas Patrick?","Je suis pas chasseur mais je lui mettrai bien une cartouche", "Poulet braisé mamène", "Benoit Zère rappeur du finistère", "Benoit Zère mon dieu","Votez Troliste", "Send Nudes"]
